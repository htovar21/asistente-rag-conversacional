    ...
    with tab_lista:
        try:
            ...
            if res.data:
                ...
                with c1:
                    # El selector usa la lista completa para evitar bloqueos si filtras la tabla
                    file_to_download = st.selectbox("Selecciona archivo para descargar:", df['filename'].tolist())
                with c2:
                    st.write(""); st.write("")
